...
let clickedIconUrl = encodeURI('data:image/svg+xml,' + clickedIconString).replace('#', '%23');
...
export default class FlightMarker extends Component {
  ...
  getIcon = (e) =>
    this.props.clicked_flight_id === this.props.flight.flight_id || this.state.mouseOn
      ? clicked_icon
      : icon;
